...
const Header = () => {
  ...
  return <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="container-wide flex justify-between items-center py-4">
        ...
        {/* Desktop Navigation - Updated with Stories from the Community */}
        <nav className="hidden lg:flex space-x-8">
          ...
          <Link to="/stories" className="text-foreground hover:text-bfa-blue font-medium transition-colors">Stories from the Community</Link>
        </nav>
      ...
      {/* Mobile Navigation - Updated with Stories from the Community */}
      {isMenuOpen && <div className="lg:hidden bg-white absolute w-full shadow-lg animate-fade-in">
          <nav className="container-wide flex flex-col py-4 space-y-4">
            ...
            <Link to="/stories" className="text-foreground hover:text-bfa-blue font-medium transition-colors" onClick={toggleMenu}>Stories from the Community</Link>
