      ...
      <section className="py-12 bg-white">
        <div className="container-wide">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg mb-6">Build for America is proud to work alongside a diverse coalition of organizations committed to creating more abundant, affordable housing through zoning reform. These trusted partners are leading the way in advocating for policy changes that expand housing options in communities across the country.


Together, we aim to grow an ever-stronger coalition of advocates, planners, elected officials, and everyday Americans united in the belief that zoning reform is essential to housing justice. By supporting each other’s efforts—locally and nationally—we can amplify our collective voice, build momentum, and ultimately put sustained pressure on Congress to pass federal legislation like Build for America.


This coalition is more than a list of names—it’s a shared commitment to real solutions, and a movement to ensure everyone has a place to call home.</p>
      ...
      <section className="py-12 bg-white">
        <div className="container-wide">
          ...
          <Accordion type="single" collapsible className="w-full">
            {Object.entries(regionalOrganizations).map(([region, orgs]) => <AccordionItem key={region} value={region}>
                <AccordionTrigger className="text-xl font-semibold text-bfa-blue-dark">
                  {region}
                </AccordionTrigger>
                <AccordionContent>
                  <div className="grid md:grid-cols-2 gap-6 pt-4">
                    {orgs.map(org => <OrganizationCard key={org.name} name={org.name} description={org.description} website={org.website} />)}
                  </div>
                </AccordionContent>
              </AccordionItem>)}
          </Accordion>
