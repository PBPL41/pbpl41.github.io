        ...
        <div className="container-wide">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              <TestimonialCard quote="Zoning should reflect the shared vision of our future growth. It should fit together the pieces of where we are now, where we're trying to go, and how we get there. We plan to transform Boston's zoning code into one that enables Boston to be a family-first, thriving city that is bustling with innovation." name="Mayor Wu's Planning Department" title="City of Boston" organization="" />
              
              <TestimonialCard quote="The shortage of affordable housing hurts everyone. Not just the homeless, but everyone from the elderly on fixed incomes to young people who want to live and raise their children in the city where they grew up, and the firemen, teachers and nurses we all depend on who can't afford to live where they work." name="Paul Krekorian" title="Former Council President" organization="Los Angeles City Council" />
              
              <TestimonialCard quote="For too long, restrictive, outdated zoning has held our city and our neighborhoods back. To address the city's decades-long housing crisis and make New York City the best place to raise a family, we must take bold, transformational action to build more homes in transit-rich areas near New Yorkers' jobs and services." name="Eric Adams" title="Mayor" organization="New York City" />
            </div>
            
            {/* Added Second Row of Testimonials */}
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <TestimonialCard quote="I'm very glad to have another opportunity to vote for more housing options in our city. I look forward to continuing conversations about how we can address our housing shortage and ensure that Portland is a place where people from all different backgrounds have the opportunity to live." name="Ted Wheeler" title="Former Mayor" organization="Portland" />
              
              <TestimonialCard quote="San Francisco should be a city with space for more families, more workers, and more dreams. Our administration wants to build enough housing for the next generation of San Franciscans, so that kids who grow up here have the same opportunity to raise their own children here. For too long, San Francisco has made it easier to block new homes than to build them. And while our needs have changed since the 1970s, much of our zoning hasn't." name="Daniel Lurie" title="Mayor" organization="San Francisco" />
              
              <TestimonialCard quote="To bring down costs, support current residents, and prepare for future growth, Seattle needs more housing and more housing choices – it's that simple." name="Bruce Harrell" title="Mayor" organization="Seattle" />
            </div>
          </div>
